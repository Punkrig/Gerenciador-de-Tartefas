...
const Login = () => {
  ...
  const submitHandler = async (data) => { // Corrected here
    ...
    <div className='w-full min-h-screen flex items-center justify-center flex-col lg:flex-row bg-[#f3f4f6]'>
      <div className="w-full md:auto flex gap-0 md:gap-40 flex-col md:flex-row items-center justify-center">
        ...
        <div className="h-full w-full lg:w-2/3 flex flex-col items-center justify-center">
          <div className="w-full md:max-w-lg 2xl:max-w-3x1 flex flex-col items-center justify-center gap-5
        ...
        <div className="w-full md:w-1/3 p-4 md:p-1 flex flex-col justify-center items-center">
          <form onSubmit={handleSubmit(submitHandler)} // Corrected here
          ...
          flex-col gap-y-8 bg-white px-10 pt-14 pb-14'>
            <div className="">
              ...
              <p className='text-center text-base text-gray-700'>Mantenha suas credenciais seguras</p>
            </div>
